...
const FormPairSelector = ({ onSubmit, tokenInfos, onClose }: IFormPairSelector) => {
  ...
  return (
    <div className="flex flex-col h-full w-full py-4 px-2 bg-v3-dark">
      <div className="flex w-full justify-between">
        <div className="text-v3-light fill-current w-6 h-6 cursor-pointer" onClick={onClose}>
          <LeftArrowIcon width={24} height={24} />
        </div>

        <div className="text-v3-light">Select Token</div>

        <div className=" w-6 h-6" />
      </div>

      <div
        className="flex px-5 mt-4 w-[98%] bg-v2-lily/10"
      ...
      >
        ...
        <input
          autoComplete="off"
          className="w-full ml-4 truncate bg-transparent text-v3-light/50 placeholder:text-v3-light/20"
          placeholder={`Search`}
      ...
      <div className="mt-2" style={{ flexGrow: 1 }}>
        ...
        {searchResult.length === 0 ? (
          <div className="mt-4 mb-4 text-center text-v3-light/50">
