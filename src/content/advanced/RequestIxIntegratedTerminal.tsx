...
const IntegratedTerminal = (props: {
  ...
  return (
    <div className="min-h-[600px] h-[600px] w-full rounded-2xl text-v3-light flex flex-col items-center p-2 lg:p-4 mb-4 overflow-hidden mt-9">
      <div className="flex flex-col lg:flex-row h-full w-full overflow-auto">
        <div className="w-full h-full rounded-xl overflow-hidden flex justify-center">
          ...
          <div
            ...
            className={`flex h-full w-full max-w-[466px] overflow-auto justify-center bg-v3-light rounded-xl ${
              !isLoaded ? 'hidden' : ''
            }`}
          />
        </div>
